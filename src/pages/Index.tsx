  ...
  return (
    <>
      <Helmet>
        ...
        <title>Friseursalon Braunschweig | 4You Hair Salon</title>
        <meta
          name="description"
          content="Besuche unseren Premium Friseursalon 4You Hair Salon in Braunschweig für erstklassige Haarschnitte, Bartpflege und individuelle Styles. Jetzt Termin buchen!"
        />
        <meta
          name="keywords"
          content="Friseursalon, Herrenfriseur, Haarschnitt, Bartpflege, Rasur, Braunschweig"
        />
        <link rel="canonical" href="https://gentlemanscut.de" />

        {/* Open Graph */}
        <meta property="og:title" content="4You Hair Salon | Premium Friseursalon Braunschweig" />
        <meta
        ...
        <meta name="twitter:title" content="4You Hair Salon | Premium Friseursalon Braunschweig" />
        <meta
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "sameAs": [
              "https://www.facebook.com/4youhairsalon",
              "https://www.instagram.com/4youhairsalon"
            ]
          })}
        </script>
      </Helmet>
